...
import pl.strefainformacji.webclient.contenful2.ContentfulClient2;
import pl.strefainformacji.webclient.contenful2.jsonArticles.dto.ContentfulArticleDto;

import java.util.ArrayList;
import java.util.List;

@Service
public class ContentfulArticleService {
    private final CDAClient client;

    public ContentfulArticleService(ContentfulClient2 contentfulClient2) {
